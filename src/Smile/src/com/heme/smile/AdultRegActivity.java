...
public class AdultRegActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.add4:
			...
			break;
		case R.id.nextstep:
			if (mUsername.getText().toString().trim().equals("")||mIdnumber.getText().toString().trim().equals("")||mPwd.getText().toString().trim().equals("")||mConfirmPwd.getText().toString().trim().equals("")) {
