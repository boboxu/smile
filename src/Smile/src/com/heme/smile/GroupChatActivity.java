...
import com.heme.smile.SingleChatActivity.GuidePageChangeListener;
...
public class GroupChatActivity extends Activity implements OnClickListener {
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case SHOW_BIG_PICTURE:
				...
				break;
			case SHOW_CARD:
				Intent cardIntent = new Intent(GroupChatActivity.this, UserDetailsActivity.class);
	...
	private boolean checkVideoPlaySupport(Intent intent) {
	        List<ResolveInfo> list = GroupChatActivity.this.getPackageManager().queryIntentActivities(intent, PackageManager.MATCH_DEFAULT_ONLY);
	        return list.size() > 0;
	    }
	...
	void showVoiceDialog(){
		dialog = new Dialog(GroupChatActivity.this,R.style.RecordingDialogStyle);
			...
			public void handleMessage(Message msg) {
				...
				case 0:
					...
					if (RECODE_STATE == RECORD_ING) {
						...
						if (recodeTime < 1.0) {
							Util.showToast(GroupChatActivity.this, "录音时间太短，失败");
							RECODE_STATE = RECORD_NO;
						} else {
							Util.showToast(GroupChatActivity.this,
									"录音完成,执行发送语音逻辑");
	...
	private void initViewPager() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(GroupChatActivity.this, listItems,
		...
		gView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				ImageSpan imageSpan = new ImageSpan(GroupChatActivity.this, bitmap);
	...
	class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 1:
				...
				SimpleAdapter simpleAdapter = new SimpleAdapter(GroupChatActivity.this,
			...
			case 2:
				...
				SimpleAdapter simpleAdapter1 = new SimpleAdapter(GroupChatActivity.this,
