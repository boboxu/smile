...
public interface IRegistManagerInterface extends
	...
	public void setParRegInfo(String realName,String idCardNo,String password,SEXTYPE sex,List<String> childIdList);
	public void setStuRegInfo(String realName,String studentId,String password,SEXTYPE sex,AreaInfo areainfo,SchoolCombine schoolInfo,ClassCombine classinfo);
