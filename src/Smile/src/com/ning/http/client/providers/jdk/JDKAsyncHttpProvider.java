...
public class JDKAsyncHttpProvider implements AsyncHttpProvider {
    ...
    private final class AsyncHttpUrlConnection<T> implements Callable<T> {
        ...
        private void configure(URI uri, HttpURLConnection urlConnection, Request request) throws IOException, Exception {
    ...
    private Proxy configureProxyAndAuth(final ProxyServer proxyServer, final Realm realm) throws Exception {
